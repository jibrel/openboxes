...
class JsonController {
    ...
    def productChanged = {
        ...
        render g.select(id:'sourceCode', name:'sourceCode', from: productSuppliers, optionKey:'code', optionValue: { it.code }, noSelection:['':''])
    }

    def sourceCodeChanged = {
        ProductSupplier productSupplier = ProductSupplier.findByCode(params.sourceCode)
